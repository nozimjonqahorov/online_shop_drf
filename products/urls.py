...
from .views import CategoryListAPIView, CategoryDetailAPIView, ProductListAPIView, ProductDetailAPIView, CartDetailView, CartItemDetailView, CartItemCreateView
